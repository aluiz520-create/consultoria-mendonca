...
interface EditarImplementoFormProps {
  id: string;
  nome: string;
  tipo: string | null;
...
export function EditarImplementoForm({ id, nome: nomeInicial, tipo: tipoInicial, custo_hora: custoHoraInicial, onClose }: EditarImplementoFormProps) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const res = await fetch(`/api/implementos/${id}`, {
      method: "PATCH",
